...
export default function BlockedPlan({ diagnosisSummary, verification }) {
  ...
  return (
    <section className="result-enter order-4 rounded-2xl border border-amber-400/30 bg-field-panel p-4 shadow-2xl shadow-black/20 sm:p-6 lg:order-none lg:col-span-2" id="treatment-plan">
      ...
      <div className="mt-4 rounded-xl border border-field-border bg-black/20 p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            className="min-h-11 rounded-lg border border-field-border px-3 py-2 text-xs font-semibold text-slate-300 transition hover:border-emerald-400/40 hover:text-white"
            onClick={copySummary}
            type="button"
          >
            {copyState}
